...
export default function MainStage({ jobId, lessonSlug }: MainStageProps) {
      ...
      <div className="flex flex-col flex-1 h-full gap-0">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-zinc-700 text-[10px] mt-1 tracking-wider">Tabs · Learn · AI</p>
          </div>
        </div>
      </div>
    );
  ...
  if (loading) {
    return (
      <div className="flex flex-col flex-1 h-full gap-0">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-zinc-500 text-xs tracking-widest font-mono animate-pulse">加载中…</div>
        </div>
      </div>
    );
  }
      ...
      <div className="flex flex-col flex-1 h-full gap-0">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-zinc-600 text-[10px] mt-2 tracking-wider">{jobId?.slice(0, 8)}…</p>
          </div>
        </div>
      </div>
    );
  ...
  if (jobId && !job) {
    return (
      <div className="flex flex-col flex-1 h-full gap-0">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-zinc-500 text-xs tracking-widest font-mono animate-pulse">加载任务…</div>
        </div>
      </div>
    );
  }
