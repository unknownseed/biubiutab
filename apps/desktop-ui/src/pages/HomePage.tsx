    ...
    <main className="bg-paper-100 py-10">
      <div className="mx-auto w-full max-w-5xl px-6">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-3xl font-serif tracking-widest text-ink-900">主菜單</h1>
          <div className="mt-2 text-sm font-light tracking-wider text-ink-700/60">{email ? `已登入：${email}` : "登入後即可開始生成、跟練與教學課程。"}</div>
        </div>
        ...
        {!email ? (
          <div className="mt-8">
            <button
              type="button"
              className="rounded-lg bg-retro-green px-6 py-3 text-sm tracking-widest text-paper-50"
